...
- **Deploy** — agent.json 一键导出到 9 种 AI 编码工具格式
- **Execute** — YAML Pipeline 引擎 + 8 内置工具 + 子 Agent 编排 + 动态覆盖
...
│           ├── agent-executor.ts   # Agent 执行编排（新增）
